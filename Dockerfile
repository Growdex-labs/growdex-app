...
ARG BACKEND_API_BASE_URL=https://api-staging.growdex.ai
ARG NEXT_PUBLIC_APP_ENV=staging
ARG NEXT_PUBLIC_BACKEND_API_URL=https://api-staging.growdex.ai
ARG NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME=djptzfvfl
ARG NEXT_PUBLIC_GOOGLE_AUTH_ENABLED=true
ARG NEXT_PUBLIC_GOOGLE_AUTH_URL=https://api-staging.growdex.ai
ARG NEXT_PUBLIC_WS_API_URL=https://api-staging.growdex.ai
