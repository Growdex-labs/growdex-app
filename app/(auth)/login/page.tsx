...
export default function LoginPage() {
  ...
  const handleDevLogin = () => {
    ...
    if (typeof document !== "undefined") {
      ...
      document.cookie =
        "access_token=mock-dev-token; path=/; max-age=86400; SameSite=Lax";
    }
  ...
  return (
    ...
    <div className="relative min-h-screen flex flex-col bg-linear-to-br from-white via-white to-amber-50">
      ...
      <div className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-6 py-6 sm:px-10 sm:py-8">
      ...
      <div className="flex flex-1">
        ...
        <div className="hidden">
          <div className="flex-1 bg-[#333333] rounded-3xl overflow-hidden flex flex-col relative">
            ...
            >
              <div className="size-12 flex items-center justify-center text-purple-300 text-4xl leading-none">
                <img
                  src="/sparkles.png"
                  alt="Wallet"
