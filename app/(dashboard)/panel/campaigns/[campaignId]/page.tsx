...
import { ChevronDown, CircleArrowRight, Facebook, InstagramIcon, MoreVerticalIcon, Search, SparklesIcon, Users } from 'lucide-react';
              ...
              <div className='bg-white rounded-xl p-4'>
                <div className='flex gap-3 items-center'>
                  ...
                  <div className='flex-1'>
                    <label htmlFor="campaignName" className="block text-sm font-medium text-gray-500">
                      Campaign Name
                    </label>
                    <input
                      type="text"
              ...
              >
                <div className='flex gap-3 items-center'>
                    <div className='flex gap-3'>
                        ...
                        <div>
                            <label htmlFor="campaignGoal" className="block text-sm font-medium text-gray-500">
                                Set Campaign goal
                            </label>
                            {/* radio group */}
                            <div className="flex flex-col mt-1 gap-3">
                                <label className="inline-flex items-center">
                                    <input type="radio" name="campaignGoal" value="awareness" className="form-radio" />
                                    <span className="ml-2">Awareness</span>
                                </label>
                                <label className="inline-flex items-center">
                                    <input type="radio" name="campaignGoal" value="traffic" className="form-radio" />
                                    <span className="ml-2">Traffic</span>
                                </label>
                                <label className="inline-flex items-center">
                                    <input type="radio" name="campaignGoal" value="conversions" className="form-radio" />
                                    <span className="ml-2">Conversions</span>
                                </label>
                                <label className="inline-flex items-center">
                                    <input type="radio" name="campaignGoal" value="leads" className="form-radio" />
                                ...
                                <ul className='list-disc list-inside'>
                                    <li>
                                        <small className="font-gilroy-bold">
                                            Show your ad to as many people as possible to increase brand visibility and reach.
                                        </small>
                                    </li>
                                </ul>
                            </div>
                ...
                <div>
                  <div className='flex gap-3'>
                    ...
                    <div className='w-full'>
                        <label htmlFor="platform" className="block text-sm font-medium text-gray-800 font-gilroy-bold">
                            Choose platform
                        </label>
                        <p className="mt-2 font-gilroy-medium text-gray-500">What platforms are you running this ad on? <span className='ml-2 hover:underline text-peru-200 cursor-pointer'>Connect new account</span></p>

                        {/* Platform Cards */}
                        <div className="flex mt-4 gap-4">
                            {/* Meta Card */}
                            <label htmlFor='meta' className="inline-flex items-start gap-2 cursor-pointer group bg-gray-50 p-2 rounded-xl">
                                <Checkbox
                                    id="meta"
                                    defaultChecked
                                ...
                                <div className="mt-2">
                                    <div className="flex items-center gap-2 text-sm font-medium text-gray-700">
                                      ...
                                      <div className="flex items-center gap-2 mt-2">
                                        <button type="button" className="text-xs text-red-500 font-medium hover:underline flex items-center gap-1">
                                            <PluggedOutIcon />
                                          Connect
                                        </button>
                                      </div>
                                ...
                                {/* TikTok Card */}
                                <label htmlFor='tiktok' className="inline-flex items-start gap-2 cursor-pointer group flex-1 mt-2 bg-mintcream-50 p-2 rounded-xl">
                                  <Checkbox
                                    id="tiktok"
                                    defaultChecked
                                    className="data-[state=checked]:bg-darkkhaki-200 data-[state=checked]:text-white data-[state=checked]:border-darkkhaki-200"
                ...
                <div>
                  <div className='flex gap-3'>
                    ...
                    <div className='w-full'>
                        ...
                        <p className="mt-2 font-gilroy-medium text-gray-500">Select the audience you want to reach <small className='inline-flex gap-1 items-center ml-2 hover:underline text-peru-200 cursor-pointer'>
                        ...
                        <div className="w-full flex flex-col gap-2 mt-4">
                            ...
                            <div className='rounded-4xl border p-3 space-y-2'>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <div className="mt-2 flex gap-2">
                                                <div className="inline-flex items-center gap-1 bg-gray-200 px-2 py-1 rounded-md">
                                                    <p>&times;</p>
                                                    <p className='text-xs font-medium text-gray-700'>Makurdi</p>
                                                </div>
                                                <div className="inline-flex items-center gap-1 bg-gray-200 px-2 py-1 rounded-md">
                                                    <p>&times;</p>
                                                    <p className='text-xs font-medium text-gray-700'>Abuja</p>
                                                </div>
                                                <div className="inline-flex items-center gap-1 bg-gray-200 px-2 py-1 rounded-md">
                                                    <p>&times;</p>
                                                    <p className='text-xs font-medium text-gray-700'>Lagos</p>
                                                </div>
                                                <div className="inline-flex items-center gap-1 bg-gray-200 px-2 py-1 rounded-md">
                                                    <p>&times;</p>
                                                    <p className='text-xs font-medium text-gray-700'>Kano</p>
                                                </div>
                                    ...
                                    <div className='p-2 bg-gray-50 h-52 rounded-xl'>
                                        ...
                                        <div className="mt-2 flex flex-col gap-2">
                                            <label htmlFor='age1' className="inline-flex items-center">
                                                <Checkbox
                                                    id="age1"
                                                    defaultChecked
                                                    className="data-[state=checked]:bg-darkkhaki-200 data-[state=checked]:text-white data-[state=checked]:border-darkkhaki-200"
                                            ...
                                            <label htmlFor='age2' className="inline-flex items-center">
                                                <Checkbox
                                                    id="age2"
                                                    defaultChecked
                                                    className="data-[state=checked]:bg-darkkhaki-200 data-[state=checked]:text-white data-[state=checked]:border-darkkhaki-200"
                                            ...
                                            <label htmlFor='age3' className="inline-flex items-center">
                                                <Checkbox
                                                    id="age3"
                                                    className="data-[state=checked]:bg-darkkhaki-200 data-[state=checked]:text-white data-[state=checked]:border-darkkhaki-200"
                                                />
                                            ...
                                            <label htmlFor='age4' className="inline-flex items-center">
                                                <Checkbox
                                                    id="age4"
                                                    className="data-[state=checked]:bg-darkkhaki-200 data-[state=checked]:text-white data-[state=checked]:border-darkkhaki-200"
                                                />
                                ...
                                <div className='p-2 bg-gray-50 rounded-xl'>
                                    ...
                                    <p className='text-gray-400'>Broad and sub-interests inferred from user activity and profile data.</p>
                                    <hr className='my-4'/>
                                    <div>
                                        <InputGroup className='bg-white'>
                  ...
                  <div className='flex gap-3'>
                    ...
                    <div className='w-full'>
                        ...
                        <div className="flex items-center justify-between font-gilroy-medium">
                            <p className="mt-2 text-gray-500">How much do you want to spend?</p>
                            <p className='ml-2 hover:underline text-peru-200 cursor-pointer'>Select Budget</p>
                        </div>
                    ...
                    <div className='w-full'>
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-4">
                            ...
                            <div className="bg-gray-50 rounded-xl p-2 space-y-2">
                                <div className='flex justify-between gap-2 px-2'>
                                    <div className="flex gap-2">
                                        <img src="/logos_meta-icon.png" alt="meta-icon" className='h-11' />
                                        <div>
                                            <p>Header</p>
                                            <p>Subhead</p>
                                        </div>
                            ...
                            <div className="bg-gray-50 rounded-xl p-2 space-y-2">
                                <div className='flex justify-between gap-2 px-2'>
                                    <div className="flex gap-2">
                                        <img src="/logos_tiktok-icon.png" alt="tiktok-icon" className='h-11' />
                                        <div>
                                            <p>Header</p>
                                            <p>Subhead</p>
                                        </div>
