                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <span className="text-lg font-bold text-firebrick-500">
                        {campaign.cpc ? `₦${campaign.cpc.toLocaleString('en-NG', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : "—"}
                      </span>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <span className="text-lg font-bold text-firebrick-500">
                          {campaign.cpa ? `₦${campaign.cpa.toLocaleString('en-NG', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : "—"}
                        </span>
                        <TrendingDown className="w-4 h-4 text-firebrick-500" />
                      </div>
